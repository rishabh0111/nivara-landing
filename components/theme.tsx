...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      title={LABELS[theme]}
      className="inline-flex items-center justify-center rounded-lg border border-line bg-surface px-2 py-1.5 text-ink-muted shadow-lift transition-colors hover:border-line-strong hover:text-ink"
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 24 24"
